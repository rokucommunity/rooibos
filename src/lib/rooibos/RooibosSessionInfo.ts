...
export class SessionInfo {
    ...
    public updateInfo() {
        ...
        for (let testSuite of [...this.testSuites.values()]) {
            ...
            testSuite.isIgnored ||= this.isExcludedByTag(testSuite, false);
            ...
            for (let testGroup of testSuite.getTestGroups()) {
                testGroup.isIgnored ||= testSuite.isIgnored || this.isExcludedByTag(testGroup, true);
                ...
                if (testGroup.isIncluded) {
                    ...
                    for (let testCase of testCases) {
                        ...
                        testCase.isIgnored ||= testGroup.isIgnored || this.isExcludedByTag(testCase, true);
