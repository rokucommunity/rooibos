...
## [5.16.5](https://github.com/rokucommunity/rooibos/compare/5.16.4...v5.16.5) - 2026-09-02
### Changed
 - Security enhancements ([#414](https://github.com/rokucommunity/rooibos/pull/414))
 - Security enhancements ([#412](https://github.com/rokucommunity/rooibos/pull/412))
 - Bump brace-expansion from 1.1.13 to 1.1.18 ([#411](https://github.com/rokucommunity/rooibos/pull/411))
 - Bump ip-address from 10.2.0 to 10.4.0 ([#410](https://github.com/rokucommunity/rooibos/pull/410))
 - Bump linkify-it from 5.0.1 to 5.0.2 ([#409](https://github.com/rokucommunity/rooibos/pull/409))
 ...
 - Bump form-data from 2.5.5 to 2.5.6 ([#406](https://github.com/rokucommunity/rooibos/pull/406))
 - Bump markdown-it from 14.1.1 to 14.2.0 ([#405](https://github.com/rokucommunity/rooibos/pull/405))
 - Bump ws from 8.20.1 to 8.21.0 ([#407](https://github.com/rokucommunity/rooibos/pull/407))
 ...
 - upgrade to [roku-debug@0.24.1](https://github.com/rokucommunity/roku-debug/blob/master/CHANGELOG.md#0241---2026-08-28). Notable changes since 0.23.11:
     - Fix debug session dying after a fragmented handshake ([#410](https://github.com/rokucommunity/roku-debug/pull/410))
     - chore: Security enhancements ([#407](https://github.com/rokucommunity/roku-debug/pull/407))
     ...
     - chore: Simplify create-vsix inputs and improve branch resolution ([#401](https://github.com/rokucommunity/roku-debug/pull/401))
     - chore: Give fork PRs a clear create-vsix failure message ([#400](https://github.com/rokucommunity/roku-debug/pull/400))
     ...
     - chore: Security enhancements ([#387](https://github.com/rokucommunity/roku-debug/pull/387))
