...
## [5.15.8](https://github.com/rokucommunity/rooibos/compare/5.15.7...v5.15.8) - 2026-04-30
### Added
...
### Changed
 ...
 - upgrade to [brighterscript@0.72.0](https://github.com/rokucommunity/brighterscript/blob/master/CHANGELOG.md#0720---2026-04-30). Notable changes since 0.67.4:
     ...
     - Add templatestring support for annotation.getArguments() ([#1264](https://github.com/rokucommunity/brighterscript/pull/1264))
 - upgrade to [roku-debug@0.23.6](https://github.com/rokucommunity/roku-debug/blob/master/CHANGELOG.md#0236---2026-04-30). Notable changes since 0.21.10:
     ...
     - Shared CI: Remove merged check on publish releases ([#260](https://github.com/rokucommunity/roku-debug/pull/260))
     - Fix telnet-still-in-use issues ([#259](https://github.com/rokucommunity/roku-debug/pull/259))
     - Add better status check for releases. Tweak README ([#256](https://github.com/rokucommunity/roku-debug/pull/256))
     ...
     - Fixed some dup var names on datetime ([#239](https://github.com/rokucommunity/roku-debug/pull/239))
     ...
     - Fixed and issue where hasFocus and isInFocusChain virtual vars where missing on nodes ([#234](https://github.com/rokucommunity/roku-debug/pull/234))
     ...
     - Fixed an issue where the entry breakpoint could be hit by the end user if they manually restarted the app ([#226](https://github.com/rokucommunity/roku-debug/pull/226))
     - Fixed a bug that would cause the stopOnEntry setting from always being respected when using restart debug session ([#223](https://github.com/rokucommunity/roku-debug/pull/223))
     - missing new lines in start up logs ([#222](https://github.com/rokucommunity/roku-debug/pull/222))
     - Updated the breakpoint manager to fail inline break point requests ([#221](https://github.com/rokucommunity/roku-debug/pull/221))
     ...
     - Task/more trigger locations in debug console ([#217](https://github.com/rokucommunity/roku-debug/pull/217))
     - feature/debugger-completions ([#211](https://github.com/rokucommunity/roku-debug/pull/211))
     ...
     - variables improvements ([#199](https://github.com/rokucommunity/roku-debug/pull/199))
     - Caught uncaught exceptions ([#198](https://github.com/rokucommunity/roku-debug/pull/198))
     ...
     - Add children roSGNode containers ([#192](https://github.com/rokucommunity/roku-debug/pull/192))
     - Add the missing `Diagnostic` props to `BSDebugDiagnostic` ([#203](https://github.com/rokucommunity/roku-debug/pull/203))
     - Upgrade dependencies ([#202](https://github.com/rokucommunity/roku-debug/pull/202))
     ...
     - Bump braces from 3.0.2 to 3.0.3 ([#193](https://github.com/rokucommunity/roku-debug/pull/193))
     - Bump micromatch from 4.0.4 to 4.0.8 ([#197](https://github.com/rokucommunity/roku-debug/pull/197))
 - upgrade to [roku-deploy@3.17.1](https://github.com/rokucommunity/roku-deploy/blob/master/CHANGELOG.md#3171---2026-04-27). Notable changes since 3.12.1:
     ...
     - chore: Upgrade to the undent package instead of dedent ([#196](https://github.com/rokucommunity/roku-deploy/pull/196))
     - chore: Shared CI remove merged check on publish releases ([#194](https://github.com/rokucommunity/roku-deploy/pull/194))
     ...
     - Fix issues with detecting "check for updates required" ([#181](https://github.com/rokucommunity/roku-deploy/pull/181))
     ...
     - Bump dependencies to remove audit issues ([#178](https://github.com/rokucommunity/roku-deploy/pull/178))
     - fixes #175 - updated regex to find a signed package on `/plugin_package` page ([#176](https://github.com/rokucommunity/roku-deploy/pull/176))
 - upgrade to [@rokucommunity/bslint@0.8.41](https://github.com/rokucommunity/bslint/blob/master/CHANGELOG.md#0841---2026-03-25). Notable changes since 0.5.0:
     ...
     - chore: Shared CI remove merged check on publish releases ([#154](https://github.com/rokucommunity/bslint/pull/154))
     ...
     - array and assocarray interace type are case insensitive ([#129](https://github.com/rokucommunity/bslint/pull/129))
     - Uprgade to bsc@0.67.5 ([#108](https://github.com/rokucommunity/bslint/pull/108))
     - add rule for roRegex duplicates ([#119](https://github.com/rokucommunity/bslint/pull/119))
     - add rule for inefficient interface types ([#115](https://github.com/rokucommunity/bslint/pull/115))
     ...
     - [WIP] Color format checking for bslint ([#94](https://github.com/rokucommunity/bslint/pull/94))
     - copy expectDiagnostics from brighterscript for tests ([#95](https://github.com/rokucommunity/bslint/pull/95))
     - Fix code flow bug with try/catch ([#93](https://github.com/rokucommunity/bslint/pull/93))
     - Performance boost by lifting some global lookups ([#92](https://github.com/rokucommunity/bslint/pull/92))
     - fix: do not consider consts as unused variables ([#85](https://github.com/rokucommunity/bslint/pull/85))
     - Fix build status badge ([cf63684](https://github.com/rokucommunity/bslint/commit/cf63684))
     - add "eol-last" to list of default rules ([#84](https://github.com/rokucommunity/bslint/pull/84))
     ...
     - Add documentatoon for bslint usage with VSCode ([#77](https://github.com/rokucommunity/bslint/pull/77))
     - Use latest github CI operating systems ([fb5f817](https://github.com/rokucommunity/bslint/commit/fb5f817))
     - Fixes issue with tagging namespaced function as Unitialized Vars ([#74](https://github.com/rokucommunity/bslint/pull/74))
     - Upgrade to bsc-0.53.1 ([#73](https://github.com/rokucommunity/bslint/pull/73))
     - Use smaller range for LINT3010 ([#70](https://github.com/rokucommunity/bslint/pull/70))
     - updates to bsc 0.50.1 ([#69](https://github.com/rokucommunity/bslint/pull/69))
     - brighterscript@0.49.0 ([061ca96](https://github.com/rokucommunity/bslint/commit/061ca96))
     - Fix unused var goto loop ([#65](https://github.com/rokucommunity/bslint/pull/65))
     - Feature: catch statement error variable ([#64](https://github.com/rokucommunity/bslint/pull/64))
     - Fixed test after brighterscript bump ([#62](https://github.com/rokucommunity/bslint/pull/62))
     - Implemented `newline-last` rule ([#58](https://github.com/rokucommunity/bslint/pull/58))
     - brighterscript@0.48.0 ([#60](https://github.com/rokucommunity/bslint/pull/60))
     - Implemented `no-stop` rule ([#57](https://github.com/rokucommunity/bslint/pull/57))
     - fix npm audit issue ([bcdedc2](https://github.com/rokucommunity/bslint/commit/bcdedc2))
     - fix(varTracking.ts): do not consider enums as unused variables. ([#59](https://github.com/rokucommunity/bslint/pull/59))
     - Implemented `no-todo` code style rule. ([#56](https://github.com/rokucommunity/bslint/pull/56))
     - Fix npm audit issues. ([3fb86d4](https://github.com/rokucommunity/bslint/commit/3fb86d4))
     - Upgrade brighterscript dependency ([#55](https://github.com/rokucommunity/bslint/pull/55))
     - fix npm audit issues. upgrade mocha, ts-node, source-map-support ([c957d8c](https://github.com/rokucommunity/bslint/commit/c957d8c))
     - fix badge url ([57f4da9](https://github.com/rokucommunity/bslint/commit/57f4da9))
     - Update badges ([ca37a8e](https://github.com/rokucommunity/bslint/commit/ca37a8e))
     - fix license ([f3d7104](https://github.com/rokucommunity/bslint/commit/f3d7104))
     - Chore - upgrade brighterscript dependency to latest 0.x ([#52](https://github.com/rokucommunity/bslint/pull/52))
     - Fix windows test issue ([8252947](https://github.com/rokucommunity/bslint/commit/8252947))
     - Add preversion hook ([43ce191](https://github.com/rokucommunity/bslint/commit/43ce191))
     - Add changelog link to bottom of readme ([3ba6573](https://github.com/rokucommunity/bslint/commit/3ba6573))
     - Fixed some audit issues. ([b0c2755](https://github.com/rokucommunity/bslint/commit/b0c2755))
     - Merge pull request #50 from rokucommunity/changelog-updates ([ccf1087](https://github.com/rokucommunity/bslint/commit/ccf1087))
     - Merge pull request #49 from rokucommunity/0.5.0 ([060f453](https://github.com/rokucommunity/bslint/commit/060f453))
     - Merge pull request #44 from rokucommunity/dependabot/npm_and_yarn/path-parse-1.0.7 ([d5ff58c](https://github.com/rokucommunity/bslint/commit/d5ff58c))
     - Merge pull request #43 from rokucommunity/dependabot/npm_and_yarn/y18n-4.0.3 ([dc7c5c6](https://github.com/rokucommunity/bslint/commit/dc7c5c6))
     - Merge pull request #45 from rokucommunity/dependabot/npm_and_yarn/glob-parent-5.1.2 ([27a9d99](https://github.com/rokucommunity/bslint/commit/27a9d99))
     - Automatically remove `as void` when changing a function to sub ([#42](https://github.com/rokucommunity/bslint/pull/42))
     - Implement AA comma linting and fixing ([#40](https://github.com/rokucommunity/bslint/pull/40))
     - Update README.md ([e774f9f](https://github.com/rokucommunity/bslint/commit/e774f9f))
     - Update README.md ([1eb272d](https://github.com/rokucommunity/bslint/commit/1eb272d))
 - upgrade to [ropm@0.11.5](https://github.com/rokucommunity/ropm/blob/master/CHANGELOG.md#0115---2026-03-24). Notable changes since 0.10.30:
