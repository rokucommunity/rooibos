...
function MT_matcher_boolean(v1, v2, expectedFail)
  returnValue = "notBroken"
  m.expectOnce(m.myClass, "doWork", [{ "matcher": MT_match_true }, { "matcher": MT_match_false }], returnValue)
...
'@Params[false, false, true]
'@Params[true, true, true]
function MT_inline_matcher_boolean(v1, v2, expectedFail)
  returnValue = "notBroken"
...
'@Params[false, false]
'@Params[true, false]
function MT_matcher_built_in_anyBoolean(v1, expectedFail)
  returnValue = "notBroken"
...
'@Params[false, true]
'@Params[true, true]
function MT_matcher_built_in_anyString(v1, expectedFail)
  returnValue = "notBroken"
...
'@Params[false, true]
'@Params[true, true]
function MT_matcher_built_in_anyNumber(v1, expectedFail)
  returnValue = "notBroken"
...
'@Params[false, true]
'@Params[true, true]
function MT_matcher_built_in_anyAA(v1, expectedFail)
  returnValue = "notBroken"
...
'@Params[false, true]
'@Params[true, true]
function MT_matcher_built_in_anyArray(v1, expectedFail)
  returnValue = "notBroken"
...
'@Params[false, true]
'@Params[true, true]
function MT_matcher_built_in_anyNode(v1, expectedFail)
  returnValue = "notBroken"
...
function MT_match_true(value)
  return value = true
end function

function MT_match_false(value)
  return value = false
end function